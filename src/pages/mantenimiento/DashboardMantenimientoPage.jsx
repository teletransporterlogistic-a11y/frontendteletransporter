...
export default function DashboardMantenimientoPage() {
  ...
  const [resumenCombustible, setResumenCombustible] = useState({});
    ...
    <div className="mantenimiento-wrapper">
      ...
      <div className="kpi-grid">
        <div className="kpi-card">
          <h3>Total litros</h3>
          <p>{resumenCombustible.totalLitros?.toFixed(2) || 0} L</p>
        </div>

        <div className="kpi-card">
          <h3>Total gastado</h3>
          <p>${resumenCombustible.totalCosto?.toFixed(2) || 0}</p>
        </div>

        <div className="kpi-card">
          <h3>Rendimiento promedio</h3>
          <p>{resumenCombustible.rendimientoPromedio?.toFixed(2) || 0} km/L</p>
        </div>

// src/pages/entregas/EntregaADomicilioPage.tsx
import { useEffect, useState } from "react";
import { useNavigate } from "react-router-dom";
import api from "@/api/api";
import BotonRegresar from "@/components/BotonRegresar";
import "./EntregaADomicilioPage.css";
...
// Componente
// ===============================
export default function EntregaADomicilioPage() {
  ...
  // ===============================
  // Cargar envíos con entrega a domicilio
  // ===============================
  async function cargarPendientes() {
    ...
    try {
      const res = await api.get("/envios", {
        params: {
          entregaDomicilio: true, // 🔥 SOLO DOMICILIO
          guia: guia || undefined,
  ...
  return (
    <div className="entregas-wrapper">
      ...
      <h2>Entregas a domicilio pendientes</h2>
          ...
          <tbody>
            {envios.map((e) => (
              <tr key={e.id}>
                ...
                <td>
                  {e.destinatarioDireccion}, {e.destinatarioCiudad},{" "}
                  {e.destinatarioEstado}
                </td>
                <td>{e.peso} kg</td>

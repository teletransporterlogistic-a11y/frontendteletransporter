...
export default function ListaEntregas() {
  ...
  async function cargarPendientes() {
    ...
    try {
      const res = await api.get("/envios", {
        params: {
          estadoActualId: 4, // 🔥 SOLO DOCUMENTADOS (pendientes de entrega)
          guia: guia || undefined,
  ...
  if (cargando) return <div className="loading">Cargando mercancía...</div>;
    ...
    <div className="entregas-wrapper">
      ...
      <div className="filtros-card">
        ...
        <div className="filtros-actions">
          <button className="btn-primary" onClick={cargarPendientes}>Buscar</button>
          ...
          <tbody>
            {envios.map((e) => (
              <tr key={e.id}>
                ...
                <td>{e.destinatarioCiudad}, {e.destinatarioEstado}</td>
                <td>{e.peso} kg</td>

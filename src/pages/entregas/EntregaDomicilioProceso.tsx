// src/pages/entregas/EntregaDomicilioProceso.tsx
...
export default function EntregaDomicilioProceso() {
  ...
  // Foto evidencia
  // ===============================
  function tomarFoto(e: React.ChangeEvent<HTMLInputElement>) {
  ...
  if (!envio) return <div className="error">No se encontró el envío.</div>;
  ...
  return (
    <div className="entrega-proceso-wrapper">
      ...
      <div className="card verificacion">
        ...
        <div className="acciones-seleccion">
          ...
          <button
            ...
            onClick={() =>
              navigate(
                `/clientes/nuevo?fromEntrega=${envio.id}&nombre=${envio.destinatarioNombre}`
              )
            }
          >
      ...
      <div className="acciones-entrega">
        <button className="btn-primary btn-entregar" onClick={entregarPaquete}>
          Confirmar entrega
        </button>

        <button
          className="btn-secondary"
          onClick={() => navigate("/entregas/domicilio")}
        >
          Cancelar
        </button>
      </div>

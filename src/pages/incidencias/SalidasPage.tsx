// src/pages/incidencias/SalidasPage.tsx
...
export default function SalidasPage() {
  const [data, setData] = useState<IncidenciaSalida[]>([]);
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-4">Segundas / Terceras Salidas</h1>

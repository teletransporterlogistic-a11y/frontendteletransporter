  ...
  return (
    <div className="confirmar-container">
      ...
      <div className="card">
        ...
        <p><strong>Dimensiones:</strong> {envio.largo} × {envio.ancho} × {envio.alto} cm</p>
        <p><strong>Total:</strong> ${envio.costoTotal?.toFixed(2)}</p>
        <p><strong>Método de pago:</strong> {envio.pago?.metodo || "No registrado"}</p>
      </div>

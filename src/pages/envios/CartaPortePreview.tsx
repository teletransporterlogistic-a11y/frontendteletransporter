// src/pages/envios/CartaPortePreview.tsx
  ...
  return (
    <div className="cp-container">
      ...
      <div className="cp-section">
        ...
        <p>
          Flete: $
          {envio.costoFlete?.toFixed(2) ??
            envio.costoTotal?.toFixed(2) ??
            "0.00"}
        </p>
        <p>Servicios: ${envio.costoServicios?.toFixed(2) ?? "0.00"}</p>
        <p>Subtotal general: ${envio.subtotal?.toFixed(2) ?? "0.00"}</p>

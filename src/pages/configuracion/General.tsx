// src/pages/configuracion/General.tsx
...
export default function General() {
  ...
  // ===============================
  const guardar = () => {
    // Aquí puedes conectar con backend cuando quieras
          ...
          <div className="mt-6">
            ...
            <label className="flex items-center gap-2 mt-2">
              <input
                ...
                checked={form.notificacionesWhatsapp}
                onChange={handleChange}
              />

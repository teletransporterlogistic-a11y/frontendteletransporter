// src/pages/DashboardOperadores.tsx
...
interface OperadorStats {
  ...
  actividadPorHora?: ActividadHora[];
}
...
// Componente
// ===============================
export default function DashboardOperadores({ token }: Props) {
  const [data, setData] = useState<OperadorStats[]>([]);
  ...
  // ===============================
  // Gráfica de líneas (actividad por hora)
  // ===============================
    ...
    <div className="max-w-5xl mx-auto bg-white p-6 rounded shadow space-y-10">
      ...
      <div>
        <h3 className="text-xl font-bold mb-3">
          Paquetes asignados por operador
        </h3>
        <Bar data={barData} />
      </div>
